...
const stats = [
  { n: '1 GB → 700 MB', l: 'Site data cleaned, with zero content lost.' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, width: '100%', maxWidth: 1000, margin: '0 auto' }}>
        {stats.map((s, i) => (
          <motion.div
            ...
            style={{ background: '#0D1A18', border: '1px solid #1A3330', borderLeft: '3px solid #009883', borderRadius: 12, padding: '22px 24px' }}
          >
            <div style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: 34, color: '#009883', lineHeight: 1.1 }}>{s.n}</div>
