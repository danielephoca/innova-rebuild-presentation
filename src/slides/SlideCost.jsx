...
const costs = [
  ...
  { big: 'Locked in', d: 'Knowledge lived in one personâ€™s head, not in the project. Hard to share or hand over.' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, width: '100%', maxWidth: 1040, margin: '0 auto' }}>
        {costs.map((c, i) => (
          <motion.div
            ...
            style={{ background: '#0D1A18', border: '1px solid #1A3330', borderTop: '3px solid #0C8870', borderRadius: 12, padding: '24px 22px', textAlign: 'center' }}
          >
            <div style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: 28, color: '#0C8870', marginBottom: 10 }}>{c.big}</div>
